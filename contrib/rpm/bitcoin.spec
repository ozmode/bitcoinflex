...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 30647
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 30648
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 40647
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 40648
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 30647
	%{_sbindir}/semanage port -d -p tcp 30648
	%{_sbindir}/semanage port -d -p tcp 40647
	%{_sbindir}/semanage port -d -p tcp 40648
