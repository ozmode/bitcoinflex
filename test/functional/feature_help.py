...
"""Verify that starting bitcoinflex with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinflex with -h for help text")
        ...
        self.log.info("Start bitcoinflex with -version for version information")
