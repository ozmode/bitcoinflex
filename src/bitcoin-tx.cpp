...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinflex-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinflex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinflex transaction") + "\n" +
              "  bitcoinflex-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinflex transaction") + "\n" +
              "\n";
