...
* bitcoinflex.conf: contains configuration settings for bitcoinflexd or bitcoinflex-qt
* bitcoinflexd.pid: stores the process id of bitcoinflexd while running
...
* debug.log: contains debug information and general logging generated by bitcoinflexd or bitcoinflex-qt
